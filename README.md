...
3) 
1. If the key Alice has matches with Bob, Alice and Bob will proceed to send message to one another.
5. If the key Alice has does not match with Bob, a prompt will appear in Bob's Serial Monitor to rebuild the key.
